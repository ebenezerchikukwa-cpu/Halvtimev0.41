...
(function () {
  ...
  const SPACING = 12; // avstand mellom prikker (px) – lavere = flere prikker
  const DOT = 0.9; // grunnstørrelse på en prikk – lavere = mindre prikker
  const RED = "217, 1, 1";
  let dots = [];
  let w = 0;
  let h = 0;
  ...
  function tegn() {
    ...
    for (const d of dots) {
      ...
      const storrelse = DOT + bolge * 0.45 + naerhet * 1.3;
